package committee.nova.mods.renderblender.api.client.render;

import com.mojang.blaze3d.vertex.VertexFormat;
import committee.nova.mods.renderblender.api.client.render.lighting.LC;
import committee.nova.mods.renderblender.api.client.render.lighting.LightModel;
import committee.nova.mods.renderblender.api.client.render.model.ModelMaterial;
import committee.nova.mods.renderblender.api.client.render.pipeline.IVertexOperation;
import committee.nova.mods.renderblender.api.client.render.pipeline.IVertexSource;
import committee.nova.mods.renderblender.api.client.render.pipeline.attribute.*;
import committee.nova.mods.renderblender.api.client.render.pipeline.attribute.AttributeKey.AttributeKeyRegistry;
import committee.nova.mods.renderblender.api.client.util.VectorUtils;
import committee.nova.mods.renderblender.api.utils.java.Copyable;
import committee.nova.mods.renderblender.api.utils.vec.*;
import committee.nova.mods.renderblender.api.utils.vec.uv.UV;
import committee.nova.mods.renderblender.api.utils.vec.uv.UVTransformation;
import committee.nova.mods.renderblender.api.utils.vec.uv.UVTranslation;
import org.jetbrains.annotations.Nullable;

import java.util.*;

import static committee.nova.mods.renderblender.api.utils.SneakyUtils.unsafeCast;
import static committee.nova.mods.renderblender.api.utils.vec.Rotation.sideRotations;
