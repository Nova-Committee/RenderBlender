...
/**
 * Represents a Key for abstract data storage on an {@link committee.nova.mods.renderblender.api.client.render.pipeline.IVertexSource}
 *
 * @see committee.nova.mods.renderblender.api.client.render.pipeline.VertexAttribute
 * @see committee.nova.mods.renderblender.api.client.render.pipeline.IVertexSource#getAttribute
